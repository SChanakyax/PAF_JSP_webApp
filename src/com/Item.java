...
public class Item {
	public Connection connect(){
		...
		try { 
			...
			con= DriverManager.getConnection("jdbc:mysql://127.0.0.1:3306/paf_lab132", "root", "");
			//For testing com.mysql.cj.jdbc.Driver
	...
	public String insertItem(String code, String name, String price, String desc){ 
		...
		try{ 
			...
			con.close(); output = "Inserted successfully"; 
			} catch (Exception e) { 
	...
	public String readItems(){
			...
			try{
				...
				con.close(); // Complete the html table
 ...
 * try        { 
	Class.forName("com.mysql.jdbc.Driver");
	DriverManager.getConnection("jdbc:mysql://127.0.0.1:3306/paf_lab132", "root", "");
	//For testing
	System.out.print("Successfully connected");     
	} catch(Exception e)  { 
		e.printStackTrace();         
